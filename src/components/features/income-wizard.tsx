          ...
          {step === 2 && path === "salary" && (
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  {fr
                    ? "Celle du siège, telle qu'elle est inscrite au registre."
                    : "The registered office, as recorded in the register."}
                </p>
              </div>
              ...
              <p className="rounded-md border border-dashed p-3 text-xs text-muted-foreground">
                ...
                <br />
                {fr ? "Vous ne les avez pas sous la main ? " : "Don't have them at hand? "}
                <ZefixHint fr={fr} />
              </p>
            </div>
          )}
